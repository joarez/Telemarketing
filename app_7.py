    ...
    if (data_file_1 is not None):
        ...
        if graph_type == 'Barras':
            sns.barplot(x = bank_raw_target_perc.index, 
                        y= bank_raw_target_perc.values.flatten(),
            ...
            sns.barplot(x = bank_target_perc.index, 
                        y= bank_target_perc.values.flatten(), 
            ...
            ax[0].pie(bank_raw_target_perc.values.flatten(), labels=bank_raw_target_perc.index, autopct='%1.2f%%')
            ax[0].set_title('Dados brutos', fontweight="bold")

            ax[1].pie(bank_target_perc.values.flatten(), labels=bank_target_perc.index, autopct='%1.2f%%')
